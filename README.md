...
Choose **Human** or **Monster**, move with WASD/arrow keys, and interact with nearby resources using **E**. Humans can build a protective campfire with **1** after gathering four wood and two stone.
